...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f0c29,50:302b63,100:24243e&height=200&section=header&text=Sidel&fontSize=60&fontColor=00fff2&animation=fadeIn&fontAlignY=35&desc=Building%20Systems%20That%20Make%20A%20Difference&descAlignY=55&descSize=18" width="100%"/>

<img src="https://readme-typing-svg.demolab.com/?font=Fira+Code&size=18&pause=1000&color=00FFF2&center=true&vCenter=true&width=600&lines=Software+Engineer;Laravel+%7C+Python+%7C+PostgreSQL+%7C+C%23;Building+Enterprise+Systems+%26+Automation" alt="Typing SVG" />
...
<img src="https://skillicons.dev/icons?i=laravel,python,postgres,cs,git,docker,vscode,linux,figma,notion" />
...
```mermaid
flowchart LR
    A[Users / Operations] --> B[Frontend<br/>Web / Mobile]
    B --> C[Laravel<br/>API / Backend]
    C --> D[(PostgreSQL<br/>Database)]
    D --> E[Python<br/>Data Processing]
    D --> F[Power BI<br/>Reporting]
```
